...
export const HISTORIC: ClassicGame[] = [
  ...
  },
  {
    ...
    category: "historic",
    level: "Legendary",
    tags: ["Game of the Century", "Sacrifice"],
    moves:
